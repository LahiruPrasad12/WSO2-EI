...
const Cart = () => {
        ...
        <>
            ...
            <div class="container">
                <div class="col-sm-12 empty-cart-cls text-center">
                    ...
                    <div className='crti'>
                        <div style={{padding: '20px', color: '#515151'}}><img
                            src="https://i.postimg.cc/SRv62yX7/ezgif-2-7ee06abb16.gif"></img></div>
                    </div>
    ...
    return (
        <div>
                                                ...
                                                <div
                                                    ...
                                                    <div className='plusm'>
                                                        <input className='crt' type="button"
                                                               ...
                                                               value="-"/>
                                                        <input className='crt' type="text" name="quantity"
                                                               value={item.quantity} maxlength="2" max="10" size="1"
                                                               id="number"/>
                                                        <input className='crt' type="button"
                                                               onClick={() => updateItemQuantity(item.id, item.quantity + 1)}
                                                               value="+"/>
            ...
            {/*Cart payment model*/}
            <div className="modal fade" id="cartPayment" data-bs-backdrop="static" data-bs-keyboard="false"
                 tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="staticBackdropLabel">Pay Invoice</h5>
            ...
            <div className="modal fade" id="mobilePayment" data-bs-backdrop="static" data-bs-keyboard="false"
                 tabIndex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="staticBackdropLabel">Mobile payment</h5>
                            <button type="button" className="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                        </div>
                        <div className="modal-body">
