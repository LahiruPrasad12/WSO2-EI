...
<div>
    ...
    <div class="row">
            ...
            <div class="d-sm-flex justify-content-between my-4 pb-4 border-bottom">
                ...
                <div class="imgBxc">
                    ...
                    <div class="media-body pt-3">
                        ...
                        <div class="font-size-sm"><span class="text-muted mr-2">SKU:</span>CA5132</div>
                        <div class="font-size-lg text-primary pt-2">LKR 125.00</div>
                    </div>
                </div>
        ...
        <div class="col-xl-3 col-md-4 pt-3 pt-md-0">
            ...
            <div class="h3 font-weight-semibold text-center py-3">LKR 1500.00</div>
            <hr/>
