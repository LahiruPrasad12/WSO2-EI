                                        ...
                                        {({errors, touched}) => (
                                            <Form>
                                                ...
                                                <div class="form-group has-success">
                                                    <label for="cc-name" class="control-label">Enter mobile
                                                        number</label>
                                                    ...
                                                    {errors.phone && touched.phone ? <p id={"login-error"} class="text-danger mt-2">{errors.phone}</p> : null}
                                                </div>
                                                <div>
                                                    <button disabled={isLoading} id="payment-button" type="submit"
                                                        ...
                                                        <span
                                                            id="payment-button-amount">{isLoading ? 'placing order...' : 'Pay now'}</span>
                                                    </button>
                                                </div>
                                            </Form>
                                        )}
