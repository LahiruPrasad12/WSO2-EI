                                        ...
                                        {({errors, touched}) => (
                                            <Form>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <h2>LKR {totalAmount}  <h6>Deliver fee :
                                                        RS.{deliveryData.price}</h6></h2>
                                                </div>
                                                <div class="form-group has-success">
                                                    ...
                                                    {errors.name && touched.name ? <p id={"login-error"} class="text-danger mt-2">{errors.name}</p> : null}
                                                </div>
                                                <div class="form-group">
                                                    <label for="cc-number" class="control-label">Card Number</label>
                                                    <Field id="cart_no" name="cart_no" type="number"
                                                    ...
                                                    {errors.cart_no && touched.cart_no ? <p id={"login-error"} class="text-danger mt-2">{errors.cart_no}</p> : null}
                                                </div>
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label for="cc-exp" class="control-label">Expiration</label>
                                                            <Field id="expiration" name="expiration" type="text"
                                                            ...
                                                            <span class="help-block" data-valmsg-for="cc-exp"
                                                                  data-valmsg-replace="true"></span>
                                                            {errors.expiration && touched.expiration ? <p id={"login-error"} class="text-danger mt-2">{errors.expiration}</p> : null}
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <label for="x_card_code" class="control-label">Security
                                                            code</label>
                                                        <div class="input-group">
                                                            <Field id="security" name="security" type="Number"
                                                                   class="form-control cc-cvc" data-val="true"
                                                        ...
                                                        {errors.security && touched.security ? <p id={"login-error"} class="text-danger mt-2">{errors.security}</p> : null}
                                                    </div>
                                                </div>
                                                <div>
                                                    <button id="payment-button" type="submit"
                                                        ...
                                                        <span id="payment-button-amount">
                                                            {isLoading ? 'placing order...' : 'Pay Now'}</span>
                                                    </button>
                                                </div>
                                            </Form>
                                        )}
